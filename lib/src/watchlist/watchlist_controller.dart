...
final links = <WikiLink>[
  ...
  WikiLink(prefix: 'ja', title: 'Category:2025年のアニメ'),
  WikiLink(prefix: 'zh', title: 'Category:2025年開播的美國電視影集'),
  WikiLink(prefix: 'uk', title: 'Категорія:Телесеріали США, запущені у 2025'),
  WikiLink(
      prefix: 'ru',
      title: 'Категория:Телесериалы России, запущенные в 2025 году'),
  WikiLink(prefix: 'ru', title: 'Категория:Пришедшие к власти в 2025 году'),
  WikiLink(prefix: 'en', title: 'Category:Dogs'),
  WikiLink(prefix: 'ru', title: 'Категория:Фильмы 2025 года'),
  WikiLink(prefix: 'en', title: 'Category:2025'),
  ...
  WikiLink(prefix: 'en', title: 'Category:2025 films'),
  WikiLink(prefix: 'en', title: 'Category:21st-century actors'),
  WikiLink(prefix: 'en', title: 'Category:2025 in television'),
  WikiLink(prefix: 'en', title: 'Category:2025 anime'),
  WikiLink(prefix: 'en', title: 'Category:2025 books'),
  WikiLink(prefix: 'en', title: 'Category:2025 in music'),
  WikiLink(prefix: 'en', title: 'Category:2025 video games'),
  WikiLink(prefix: 'en', title: 'Category:2025 in basketball'),
  WikiLink(prefix: 'en', title: 'Category:2025 in ice hockey'),
  WikiLink(prefix: 'en', title: 'Category:2025 in snooker'),
  WikiLink(prefix: 'en', title: 'Category:2025 in biathlon'),
  WikiLink(prefix: 'en', title: 'Category:2025 in alpine skiing'),
  WikiLink(prefix: 'en', title: 'Category:2025 in figure skating'),
  WikiLink(prefix: 'en', title: 'Category:2025 in ice hockey'),
  WikiLink(prefix: 'en', title: 'Category:2025 in tennis'),
  WikiLink(prefix: 'en', title: 'Category:2025 crimes'),
  ...
  WikiLink(prefix: 'en', title: 'Category:2025 software'),
  WikiLink(
      prefix: 'en',
      title: 'Category:Buildings and structures completed in 2025'),
  WikiLink(
      prefix: 'en',
      title: 'Category:Buildings and structures demolished in 2025'),
  WikiLink(prefix: 'en', title: 'Category:Current events'),
  WikiLink(prefix: 'en', title: 'Category:2025 in science'),
  WikiLink(prefix: 'en', title: 'Category:2025 in politics'),
  WikiLink(prefix: 'en', title: 'Category:2025 in sports'),
  WikiLink(prefix: 'en', title: 'Category:2025 in aviation'),
  WikiLink(prefix: 'en', title: 'Category:2025 in technology'),
];
